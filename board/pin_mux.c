...
- {pin_num: '73', pin_signal: CMP1_IN1/PTC3/LLWU_P7/SPI0_PCS1/UART1_RX/FTM0_CH2/CLKOUT/I2S0_TX_BCLK, label: 'J1[16]', identifier: ILI9341_RST}
...
- {pin_num: '76', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/CMP1_OUT, label: 'J2[4]', identifier: ILI9341_DC}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_ILI9341_RST_GPIO, BOARD_ILI9341_RST_PIN, &ILI9341_RST_config);

    gpio_pin_config_t ILI9341_DC_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
