...
/*! @name PORTC3 (number 73), J1[16]
  @{ */
#define BOARD_ILI9341_RST_GPIO GPIOC /*!<@brief GPIO device name: GPIOC */
#define BOARD_ILI9341_RST_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_ILI9341_RST_PIN 3U     /*!<@brief PORTC pin index: 3 */
                                     /* @} */

/*! @name PORTC4 (number 76), J2[4]
  @{ */
#define BOARD_ILI9341_DC_GPIO GPIOC /*!<@brief GPIO device name: GPIOC */
#define BOARD_ILI9341_DC_PORT PORTC /*!<@brief PORT device name: PORTC */
